    ...
    def __init__(self, cfg: DictConfig):
        ...
        for _ in range(cfg.model.self_attention_layer):
            self.attention_list.append(
                TransformerEncoderLayer(d_model=cfg.dataset.node_feature_sz, nhead=cfg.model.nhead, dim_feedforward=1024,
                                        batch_first=True)
            )
        ...
        output_dim = 1 if cfg.dataset.regression else cfg.dataset.num_classes
