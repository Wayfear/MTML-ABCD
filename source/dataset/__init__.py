...
from .emory import load_emory_data
from .aurora import load_aurora_data
from .abcd_mtml import load_abcd_mtml_data
...
def dataset_factory(cfg: DictConfig) -> List[utils.data.DataLoader]:
    ...
    assert cfg.dataset.name in ['abcd', 'abcd_mtml', 'abide', 'pnc', 'tcga', 'emory', 'aurora']
